...
text = replace_once(
    ...
    lines(
        "# ---------------------------------------------------------",
        "#",
        "ARG BC_RUN_PREFIX=posthog-bc-run-cachemount-20260522b",
        "",
...
text = replace_once(
    ...
    lines(
        ...
        "        -- sh -lc 'corepack enable && pnpm --version && CI=1 pnpm --filter=@posthog/frontend... install --frozen-lockfile --store-dir /tmp/pnpm-store-v24 && rm -rf /tmp/pnpm-store-v24/v*/projects'; \\",
