...
- [`.github/workflows/posthog-benchmark.yml`](.github/workflows/posthog-benchmark.yml) runs weekly fresh, upstream-driven rolling, and pull-request validation lanes for GitHub Actions Cache and the BoringCache OCI and BuildKit products.
- [`.github/workflows/canary-dispatch.yml`](.github/workflows/canary-dispatch.yml) runs an isolated fresh benchmark against a selected canary CLI and BuildKit image.
