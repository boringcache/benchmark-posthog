...
require_text "$runner" "same_ref_oci_semantics_equal"
...
require_text "$runner" "--output \"type=oci,dest=\${oci_archive_path},rewrite-timestamp=true\""
require_text "$runner" "image_manifest_digest"
require_text "$runner" "config_digest"
require_text "$runner" "diff_ids"
